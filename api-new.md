...
##LinkActive交互图
![](/assets/API流程0526.png)

简要说明：

1. 处理广告结果<br>客户端需要判断返回广告列表中的广告所属的广告主应用终端用户是否安装，并去掉未安装APP的广告，只保留已安装APP的广告

2. 删除广告<br>已经点击并唤起广告主APP之后，要将该条广告删除，以免发生二次点击，造成流量浪费

3. 回调广告行为<br>（建议由媒体方服务端拼接参数返回给app，再由app向LinkActive Servers发起请求）
